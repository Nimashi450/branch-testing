<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
        ...
        //  $_SESSION['farmName'] = $row['farm_name'] ;
        //  $_SESSION['farmLocation'] = $row['farm_location'] ;
        //  $_SESSION['farmLong'] = $row['farmLongitude'] ;
        //  $_SESSION['farmLat'] = $row['farmLatitude'] ;
        //  $_SESSION['farmid'] = $row['farmID'];
